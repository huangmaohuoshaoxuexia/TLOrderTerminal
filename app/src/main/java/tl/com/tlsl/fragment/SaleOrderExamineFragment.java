...
public class SaleOrderExamineFragment extends Fragment implements IMvpView{
    private View v;
...
//    private SaleOrderAdapter mAdapter;
    ...
    public void flushList(String status){
        ...
        x = 1;
        mOrderStatus = status;
        saleOrderPresenter.getMyList("",status,"",page);
            ...
            public void onRefresh() {
                new Handler().postDelayed(new Runnable(){
                    public void run() {
                        page = 1;
                        x = 1;
                        saleOrderPresenter.getMyList("",mOrderStatus,"",page);
                        xRecyclerView.refreshComplete();
                        xRecyclerView.setLoadingMoreEnabled(true);
                    }
                }, 1000);
